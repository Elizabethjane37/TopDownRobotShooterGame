...
File name: MyExitButton
Purpose: Button object which exits the user from the main menu
References:
...
package  {
	...
	public class MyExitButton extends SimpleButton {
		private var stageRef:Stage;
		
		

		public function MyExitButton(stageRef:Stage, X:int, Y:int):void{
