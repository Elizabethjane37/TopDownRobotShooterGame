...
File name: MyHelpButton
Purpose: Button oject taking user to frame 3 (help menu)
References:
...
package  {
	...
	public class MyHelpButton extends SimpleButton {
		private var stageRef:Stage;
		
		
		public function MyHelpButton(stageRef:Stage, X:int, Y:int):void{
